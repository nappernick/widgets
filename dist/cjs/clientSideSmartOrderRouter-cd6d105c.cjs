...
var index = require('./index-e6d71a73.cjs');
...
var AUTO_ROUTER_SUPPORTED_CHAINS = Object.values(index.SupportedChainId).filter(function (chainId) {
...
function getRouter(chainId, provider) {
  ...
  if (chainId !== index.SupportedChainId.MAINNET) {
  ...
  if ([index.SupportedChainId.POLYGON, index.SupportedChainId.POLYGON_MUMBAI].includes(chainId)) {
