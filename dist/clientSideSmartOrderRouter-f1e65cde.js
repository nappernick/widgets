...
import { i as isExactInput, Q as QuoteState, S as SwapRouterNativeAssets, n as nativeOnChain } from './index-b8618e78.js';
...
var ChainId = /*#__PURE__*/function (ChainId) {
...
function getRouter(chainId, provider) {
  ...
  if ([ChainId.POLYGON, ChainId.POLYGON_MUMBAI].includes(chainId)) {
    ...
    // @ts-ignore
    chainId, provider, multicall2Provider, {
      retries: 2,
      minTimeout: 100,
      maxTimeout: 1000
    }, {
