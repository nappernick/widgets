          ...
          return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
            ...
            return _regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 28:
                  _context2.next = 30;
                  return import('./clientSideSmartOrderRouter-f1e65cde.js');
                case 30:
...
function useTradeExchangeRate(trade, outputUSDC) {
  ...
  return useMemo(function () {
    return [// @ts-ignore
    "".concat(1, " ", price.baseCurrency.symbol, " = ").concat(formatPrice(price, NumberType.TokenTx), " ").concat(price.quoteCurrency.symbol), usdcPrice && formatCurrencyAmount$1(usdcPrice, NumberType.FiatTokenPrice)];
  }, [price, usdcPrice]);
}
