...
import { i as isExactInput, Q as QuoteState, S as SupportedChainId, a as SwapRouterNativeAssets, n as nativeOnChain } from './index-9e9c590c.js';
...
var AUTO_ROUTER_SUPPORTED_CHAINS = Object.values(SupportedChainId).filter(function (chainId) {
...
function getRouter(chainId, provider) {
  ...
  if ([SupportedChainId.POLYGON, SupportedChainId.POLYGON_MUMBAI].includes(chainId)) {
...
//# sourceMappingURL=clientSideSmartOrderRouter-bce6b44f.js.map
